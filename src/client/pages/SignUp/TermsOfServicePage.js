...
const TermsOfServicePage = props => {
    const cx = classnames(s.staticPage, 'termsofservice-page')
    return (
        <div className={cx}>
                    ...
                    <div className="col-sm-12 col-lg-6">
                        <div className="card my-3">
                            <div className="card-title text-center mt-2">
                                <h2>Baza Foundation Terms of Service</h2>
                            </div>
                            <div className="card-body">
                                ...
                                <p>
                                    ...
                                    terms of service, all applicable laws and
                                    regulations, and agree that you are
                                    responsible for compliance with any
                                    applicable local laws. If you do not agree
                                    with any of these terms, you are prohibited
                                    from using or accessing this site. The
                                    materials contained in this website are
                                    protected by applicable copyright and
                                    trademark law.
                                </p>
                                <h3>2. Use License</h3>
                                <ol type="a">
                                    <li>
                                        ...
                                        (information or software) on Baza
                                        Foundation's website for personal,
                                        non-commercial transitory viewing only.
                                        This is the grant of a license, not a
                                        ...
                                        <ol type="i">
                                            ...
                                            <li>
                                                ...
                                                commercial purpose, or for any
                                                public display (commercial or
                                                non-commercial);
                                            </li>
                                            <li>
                                                attempt to decompile or reverse
                                                engineer any software contained
                                                on Baza Foundation's website;
                                            </li>
                                            <li>
                                    ...
                                    <li>
                                        ...
                                        Baza Foundation at any time. Upon
                                        terminating your viewing of these
                                        materials or upon the termination of
                                        this license, you must destroy any
                                ...
                                <ol type="a">
                                    <li>
                                        The materials on Baza Foundation's
                                        website are provided on an 'as is'
                                        basis. Baza Foundation makes no
                                    ...
                                    <li>
                                        Further, Baza Foundation does not
                                ...
                                <h3>4. Limitations</h3>
                                <p>
                                    In no event shall Baza Foundation or its
                                    ...
                                    inability to use the materials on Baza
                                    Foundation's website, even if Baza
                                    Foundation or a Baza Foundation authorized
                                    representative has been notified orally or
                                    in writing of the possibility of such
                                    damage. Because some jurisdictions do not
                                    allow limitations on implied warranties, or
                                    limitations of liability for consequential
                                    or incidental damages, these limitations may
                                    not apply to you.
                                </p>
                                <h3>5. Accuracy of materials</h3>
                                <p>
                                    The materials appearing on Baza Foundation's
                                    website could include technical,
                                    typographical, or photographic errors. Baza
                                    Foundation does not warrant that any of the
                                    materials on its website are accurate,
                                    complete or current. Baza Foundation may
                                    make changes to the materials contained on
                                    its website at any time without notice.
                                    However Baza Foundation does not make any
                                    commitment to update the materials.
                                </p>
                                <h3>6. Links</h3>
                                <p>
                                    Baza Foundation has not reviewed all of the
                                    sites linked to its website and is not
                                    responsible for the contents of any such
                                    linked site. The inclusion of any link does
                                    not imply endorsement by Baza Foundation of
                                    the site. Use of any such linked website is
                                    at the user's own risk.
                                </p>
                                <h3>7. Modifications</h3>
                                <p>
                                    Baza Foundation may revise these terms of
                                    service for its website at any time without
                                    notice. By using this website you are
                                    agreeing to be bound by the then current
                                ...
                                <p>
                                    ...
                                    Virginia and you irrevocably submit to the
