      ...
      <div className="container page-section">
        ...
        <div className="row">
          <div className="col-lg-8">
            <h4 className="section-title-underlined">Donation Status</h4>
            <p>
              When donation reach the goal an automatic purchase of the baza and
              crypto on the market will be purchased then distributed to the
              qualifying Baza account holders in the form of basic income
            </p>

            <h4 className="section-title-underlined">Where we are</h4>
            <p>
              When donation reach the goal an automatic purchase of the baza and
              crypto on the market will be purchased then distributed to the
              qualifying Baza account holders in the form of basic income
          ...
          <div className="col-lg-4 mt-3 mt-lg-0 mt-xl-0">
            <h4 className="section-title-underlined">Just Donated</h4>
            <DonationList />
          </div>
        </div>
      </div>
