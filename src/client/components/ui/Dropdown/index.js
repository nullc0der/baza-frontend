...
export default class UIDropdown extends Component {
  ...
  componentDidMount = () => {
    ...
    $(this.root)
      .find('.ui-dropdown-item')
      .on('click', this.closeDD)
  }
  ...
  handleClick = e => {
    ...
    $root
      ...
      .each(function() {
        if ($(this).is($root)) {
          $(this)
            .find('.ui-dropdown-toggle')
            .hasClass('is-active')
            ? $(this)
                .find('.ui-dropdown-toggle, .ui-dropdown-list')
                .removeClass('is-active')
            : $(this)
                .find('.ui-dropdown-toggle, .ui-dropdown-list')
                .addClass('is-active')
  ...
  render() {
    ...
    return (
      <div className={cx} ref={node => (this.root = node)}>
        ...
        <div className={listClass}>
          ...
          <div className={footerClass}>{dropdownFooter}</div>
        </div>
      </div>
    )
  }
