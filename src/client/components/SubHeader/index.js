...
class SubHeader extends Component {
    ...
    toggleIssueCreator = () => {
        this.setState(prevState => ({
            showIssueDialog: !prevState.showIssueDialog
        }))
    }
        ...
        return (
            <div className={cx}>
                ...
                <button
                    ...
                    onClick={this.toggleIssueCreator}>
                    <i className="fa fa-bug" />
                </button>
                <IssueCreator
                    isOpen={this.state.showIssueDialog}
                    onRequestClose={this.toggleIssueCreator}
                />
            </div>
        )
    }
...
const mapDispatchToProps = dispatch => ({
    changeSearchString: string =>
        dispatch(actions.changeSubHeaderSearchString(string)),
