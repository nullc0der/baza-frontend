...
export const reassignStaff = (datas) => {
    return jsonAPI((api) =>
        api.post('/bazasignup/signup/reassignstaff/', datas)
    )
}
...
export const toggleOnDistribution = (signupID, on_distribution) => {
    return jsonAPI((api) =>
        api.post(`/bazasignup/signup/${signupID}/toggledistribution/`, {
            on_distribution,
        })
    )
}
